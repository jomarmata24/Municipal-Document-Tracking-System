...
Public Class Frm_Update_RFID
                ...
                If dr.Read() Then
                    ...
                    If result = DialogResult.OK Then
                        ...
                        With FrmUpdateMember
                            .TopLevel = False
                            Frm_Main_Update_Member.RFID_main_update_panel.Controls.Add(FrmUpdateMember)
                            .BringToFront()
                            .Show()
    ...
    Private Sub Frm_Update_RFID_Load(sender As Object, e As EventArgs) Handles MyBase.Load
